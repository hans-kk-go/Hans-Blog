...
import com.hans.domain.dto.LoginDto;
import com.hans.enums.AppHttpCodeEnum;
import com.hans.domain.vo.backstage.AdminInfoVo;
import com.hans.domain.vo.backstage.MenuVo;
import com.hans.domain.vo.backstage.RoutersVo;
import com.hans.domain.vo.forestage.UserInfoVo;
...
public class AdminLoginController {
    ...
    public ResponseResult<Map<String,String>> login(@Validated @RequestBody LoginDto loginDto){
        if (!Strings.hasText(loginDto.getUserName())){
            throw new BusinessException(AppHttpCodeEnum.REQUIRE_USERNAME);
        }
